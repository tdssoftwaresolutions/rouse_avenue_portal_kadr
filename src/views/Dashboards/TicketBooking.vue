              ...
              <div class="iq-booking-offer iq-bg-primary">
                <div class="row justify-content-between">
                  ...
                  <div class="col-6">
                    ...
                    <a href="#" class="btn btn-primary mt-3">Learn more<i class="ri-arrow-right-line ms-2"></i></a>
                  </div>
                </div>
              </div>
              <div class="pt-4">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="row mt-5 pt-3 seat-booking">
                      <div class="col-1 col-1 col-1 text-right">
                      ...
                      <div class="col-10 col-10 col-10 text-center">
                        ...
                        <ul :class="'list-inline iq-booking-no '+boxItem.className" v-for="(boxItem,boxIndex) in boxSeats" :key="'boxSeat'+boxIndex">
                          <li class="list-inline-item ms-1" v-for="(item,index) in boxItem.items" :key="index" :class="(item.seat === false ? 'li-blank' : '')">
                        ...
                        <ul :class="'list-inline iq-booking-no '+goldItem.className" v-for="(goldItem,goldIndex) in goldSeats" :key="'goldSeat'+goldIndex">
                          <li class="list-inline-item ms-1" v-for="(item,index) in goldItem.items" :key="index" :class="(item.seat === false ? 'li-blank' : '')">
                            <a href="javascript:void(0)" @click="updateSeat(item)" class="iq-seat" v-if="item.seat" v-show="item.available" :class="item.active ? 'active' : ''">
                              <img :src="require('../../assets/images/small/04.svg')" alt="" class="default">
                              <img :src="require('../../assets/images/small/05.svg')" alt="" class="active-seat">
                            </a>
                        ...
                        <ul :class="'list-inline iq-booking-no '+silverItem.className" v-for="(silverItem,silverIndex) in sliverSeats" :key="'silverSeat'+silverIndex">
                          <li class="list-inline-item ms-1" v-for="(item,index) in silverItem.items" :key="index" :class="(item.seat === false ? 'li-blank' : '')">
                            <a href="javascript:void(0)" @click="updateSeat(item)" class="iq-seat" v-if="item.seat" v-show="item.available" :class="item.active ? 'active' : ''">
                              <img :src="require('../../assets/images/small/04.svg')" alt="" class="default">
                              <img :src="require('../../assets/images/small/05.svg')" alt="" class="active-seat">
                            </a>
                      ...
                      <div class="col-1 col-1 col-1 text-left">
                        <ul class="list-unstyled iq-booking-ab">
                          <li class="friest-booking-blank"></li>
                          <li>A</li>
                          <li>B</li>
                      ...
                      <div class="col-12 col-10 col-10 text-center mt-3">
                        ...
                        <div class="iq-booking-status ms-0">
    ...
    <div class="iq-sidebar-right-menu hide" :class="sidebarTicket ? 'film-side' : ''">
      <div id="right-sidebar-scrollbar">
        <div class="iq-sidebar-booking bg-primary">
          ...
          <div class="iq-booking-ticket">
            <dl class="row line-height-4">
              <dt class="col-4 font-weight-normal font-size-16 text-dark">Nioking</dt>
              <dd class="col-8 mb-0">20th jan, 20:00</dd>
              <dt class="col-4 font-weight-normal text-dark">Avengers</dt>
              <dd class="col-8 mb-0">HK5894J</dd>
              <dt class="col-4 font-weight-normal text-dark">SCREEN2</dt>
              <dd class="col-8 mb-0">D17, D18, D19 (3 Tickets)</dd>
            </dl>
        ...
        <div class="iq-sidebar-payment">
          ...
          <div class="custom-control custom-checkbox mt-4 ms-1">
