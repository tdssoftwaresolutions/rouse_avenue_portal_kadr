...
import ChatItem from '../../../components/sofbox/Chat/ChatItem'
import ToggleButton from '../../../components/sofbox/Chat/ToggleButton'
import ToggleContent from '../../../components/sofbox/Chat/ToggleContent'
...
export default {
  ...
  methods: {
    ...
    generate () {
      this.channel = sofbox.random(24)
    },
    copyText () {
      sofbox.Snackbar({ text: 'Copied' })
    }
  }
}
</script>
