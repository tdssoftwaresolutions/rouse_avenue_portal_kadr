<template>
    <b-container fluid>
                ...
                <template v-slot:body>
                  <b-row>
                    ...
                    <b-col lg="12" class="mt-3">
                      ...
                      <span class="h2 text-dark mb-0 counter d-inline-block w-100">{{ content.stats.totalCases }}</span>
                    </b-col>
                  </b-row>
                </template>
              </iq-card>
                ...
                <template v-slot:body>
                  <b-row>
                    ...
                    <b-col lg="12" class="mt-3">
                      ...
                      <span class="h2 text-dark mb-0 counter d-inline-block w-100">{{  content.stats.inProgressCases }}</span>
                    </b-col>
                  </b-row>
                  </template>
                </iq-card>
      ...
      <b-row>
        <b-col lg="12" md="12">
          <JudgeMyMediations :nextCaseId="content.nextCaseId" :cases="content.myCases" :user="user"/>
        </b-col>
      </b-row>
    </b-container>
</template>
